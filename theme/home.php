			...
			<header class="entry-header has-bg <?php echo $has_featured_img_cssClass ?>">
				...
				?>
					...
					<div class="entry-header-content layout-site-width">
						<?php
						if ( !is_front_page() ) {
							single_post_title( '<h1 class="entry-title" data-anim_any data-anim_any_whattoanim="chars" data-anim_any_animation="clippedFromBottom" data-anim_any_waitpageload="true" data-anim_any_duration="1" data-anim_any_stagger="0.05" >', '</h1>' );
						}
